...
def reset_game():
    ...
    platforms_data = [
        ...
        [5250, 350, 150, PLATFORM_THICKNESS, COLOR_BROWN],
    ]
    ...
    #Create obstacles
    obstacles_data = [
        # Color doesn't matter for objects with a set object type
        ...
        [4700, SCREEN_HEIGHT-GROUND_THICKNESS-150, 75, 150, COLOR_GRAY, "PIPE"],
        [5050, SCREEN_HEIGHT-GROUND_THICKNESS-250, 75, 250, COLOR_GRAY, "PIPE"],
    ...
    enemies_data = [
        ...
        [4850 - ENEMY_WIDTH, SCREEN_HEIGHT-GROUND_THICKNESS - ENEMY_HEIGHT, ENEMY_WIDTH, ENEMY_HEIGHT, ENEMY_COLOR, ENEMY_SPEED, False, ENEMIES_SPRITE_SHEET_PATH],
        [5200 - ENEMY_WIDTH, SCREEN_HEIGHT-GROUND_THICKNESS - ENEMY_HEIGHT, ENEMY_WIDTH, ENEMY_HEIGHT, ENEMY_COLOR, ENEMY_SPEED, False, ENEMIES_SPRITE_SHEET_PATH],
        [5500 - ENEMY_WIDTH, SCREEN_HEIGHT-GROUND_THICKNESS - ENEMY_HEIGHT, ENEMY_WIDTH, ENEMY_HEIGHT, ENEMY_COLOR, ENEMY_SPEED, True, ENEMIES_SPRITE_SHEET_PATH],
    ] 
